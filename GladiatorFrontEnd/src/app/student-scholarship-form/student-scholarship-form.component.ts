  ...
  this.form=new FormGroup(
    {
      ...
      student10RollNo:new FormControl(''),
      student10BoardName:new FormControl(''),
      student10PassingYear:new FormControl(''),
      student10Percent:new FormControl(''),
      student12RollNo: new  FormControl(''),
      student12BoardName:new FormControl(''),
      student12PassingYear: new FormControl(''),
      student12Percent: new FormControl(''),
