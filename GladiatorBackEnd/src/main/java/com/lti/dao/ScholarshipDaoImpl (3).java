...
public class ScholarshipDaoImpl implements ScholarshipDao {
	...
	public List<StudentDetails> readStudentForInstitute(String instituteCode) {
		String jpql= "select s from StudentDetails s where s.registration.studentAadharNo=(select r.studentAadharNo from StudentRegistrationDetails r where r.institute.instituteCode = :instituteCode) and s.applicationStatus='Pending'";                                          
